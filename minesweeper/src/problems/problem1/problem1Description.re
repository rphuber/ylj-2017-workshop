...
If you open the file `minesweeper/src/problems/problem1/problem1.re` in your editor, you'll come face to face with your first React component using reason bindings. We're going to see a lot of these as we build up this application, so I'll explain a little bit of what you're looking at.
